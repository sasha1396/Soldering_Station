...
{
	LDP &= ~((1<<LCD_D7)|(1<<LCD_D6)|(1<<LCD_D5)|(1<<LCD_D4)); // сбрасываем данные
	...
	LCP&=~(1<<LCD_RS);
	_delay_ms(1);
	LDP &= ~((1<<LCD_D7)|(1<<LCD_D6)|(1<<LCD_D5)|(1<<LCD_D4)); //сброс данных с порта
}
//*****************************************************************************
...
//*****************************************************************************
void lcd_string(char* data, char nBytes)	// Вывод строки на дисплей
{
	register char i;
